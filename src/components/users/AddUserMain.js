...
const AddUserMain = () => {
    ...
    useEffect(() => {
        if (user) {
            toast.success("Thêm người dùng thành công", ToastObjects);
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        dispatch(createUser(firstName, lastName, email, phoneNumber, username, avatar, thumb, province, district,
            ward, street, longitude, latitude, role));
    };
